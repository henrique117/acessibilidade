...
class RelatorioController extends Controller
{
    private function prepararDadosRelatorio(Request $request)
    {
        ...
        $principio1 = 0; $principio2 = 0; $principio3 = 0; $principio4 = 0;
        $qtdAlta = 0; $qtdMedia = 0; $qtdBaixa = 0;
            ...
            if ($isRelatorioCompleto || in_array($indexStr, $paginasSelecionadas)) {
                ...
                foreach ($erros as $erro) {
                    ...
                    if ($afetaEstaPagina) {
                        ...
                        if ($erro->criticidade === 'Alta') $qtdAlta++;
                        elseif ($erro->criticidade === 'Média') $qtdMedia++;
                        elseif ($erro->criticidade === 'Baixa') $qtdBaixa++;
        ...
        $estatisticasDetalhadas = [
            ...
            'perc_Alta' => $calcPerc($qtdAlta),
            'perc_Media' => $calcPerc($qtdMedia),
            'perc_Baixa' => $calcPerc($qtdBaixa),
